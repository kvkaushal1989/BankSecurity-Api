...
{
    [RoutePrefix("v1/bank-security/Blacklistedplayer")]
    public class Wem_BlacklistController : ApiController {
        IWem_BlacklistRepository repository = new Wem_BlacklistRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wem_Blacklist postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wem_Blacklist postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "BlacklistedplayerPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wem_Blacklist> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "BlacklistedplayerPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
