...
{
    [RoutePrefix("v1/bank-security/Staffperformance")]
    public class Stuff_PerformanceController : ApiController {
        IStuff_PerformanceRepository repository = new Stuff_PerformanceRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Stuff_Performance postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Stuff_Performance postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "StaffperformancePaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Stuff_Performance> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "StaffperformancePaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
