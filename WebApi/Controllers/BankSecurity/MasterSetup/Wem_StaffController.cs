...
{
    [RoutePrefix("v1/bank-security/StaffMaster")]
    public class Wem_StaffController : ApiController {
        IWem_StaffRepository repository = new Wem_StaffRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wem_Staff postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wem_Staff postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "StaffMasterPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wem_Staff> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "StaffMasterPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
