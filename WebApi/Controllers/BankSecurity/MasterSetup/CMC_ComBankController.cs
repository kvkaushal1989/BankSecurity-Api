...
namespace WebApi.Controllers.BankSecurity.MasterSetup
{
    ...
    /// Company Bank Setup
    /// </summary>
    [RoutePrefix("v1/bank-security/CompanyBankSetup")]
    public class CMC_ComBankController : ApiController {
        ICMC_ComBankRepository repository = new CMC_ComBankRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(CMC_ComBank postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(CMC_ComBank postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "CompanyBankSetupPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<CMC_ComBank> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "CompanyBankSetupPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
