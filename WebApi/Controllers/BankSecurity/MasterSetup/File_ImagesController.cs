...
{
    [RoutePrefix("v1/bank-security/KioskvsAdmin")]
    public class File_ImagesController : ApiController {
        IFile_ImagesRepository repository = new File_ImagesRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(File_Images postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(File_Images postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "KioskvsAdminPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<File_Images> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "KioskvsAdminPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
