...
{
    [RoutePrefix("v1/bank-security/NewPlayer")]
    public class Wem_PlayerController : ApiController {
        IWem_PlayerRepository repository = new Wem_PlayerRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wem_Player postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wem_Player postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "NewPlayerPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wem_Player> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "NewPlayerPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
