...
{
    [RoutePrefix("v1/bank-security/ExpensesTypeDetails")]
    public class ExpensesdetController : ApiController {
        ICMC_ExpensesdetRepository repository = new CMC_ExpensesdetRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(CMC_Expensesdet postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(CMC_Expensesdet postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "ExpensesTypeDetailsPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<CMC_Expensesdet> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "ExpensesTypeDetailsPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
