...
{
    [RoutePrefix("v1/bank-security/BlacklistedplayerAccSetup")]
    public class Wem_BlacklistaccController : ApiController {
        IWem_BlacklistaccRepository repository = new Wem_BlacklistaccRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wem_Blacklistacc postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wem_Blacklistacc postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "BlacklistedplayerAccSetupPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wem_Blacklistacc> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "BlacklistedplayerAccSetupPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
