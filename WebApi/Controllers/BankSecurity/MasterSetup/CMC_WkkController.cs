...
{
    [RoutePrefix("v1/bank-security/WKKphoneidsetup")]
    public class CMC_WkkController : ApiController {
        ICMC_WkkRepository repository = new CMC_WkkRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(CMC_Wkk postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(CMC_Wkk postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "WKKphoneidsetupPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<CMC_Wkk> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "WKKphoneidsetupPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
