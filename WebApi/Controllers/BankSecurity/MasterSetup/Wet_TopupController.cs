...
{
    [RoutePrefix("v1/bank-security/PlayerTopup")]
    public class Wet_TopupController : ApiController {
        IWet_TopupRepository repository = new Wet_TopupRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wet_Topup postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wet_Topup postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "PlayerTopupPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wet_Topup> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "PlayerTopupPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
