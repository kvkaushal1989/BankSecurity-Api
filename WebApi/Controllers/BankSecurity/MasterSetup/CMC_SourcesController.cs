...
{
    [RoutePrefix("v1/bank-security/Contactsourcessetup")]
    public class CMC_SourcesController : ApiController {
        ICMC_SourcesRepository repository = new CMC_SourcesRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(CMC_Sources postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(CMC_Sources postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "ContactsourcessetupPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<CMC_Sources> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "ContactsourcessetupPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
