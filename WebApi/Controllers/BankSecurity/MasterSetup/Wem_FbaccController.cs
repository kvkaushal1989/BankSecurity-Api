...
{
    [RoutePrefix("v1/bank-security/Addaccount")]
    public class Wem_FbaccController : ApiController {
        IWem_FbaccRepository repository = new Wem_FbaccRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wem_Fbacc postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wem_Fbacc postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "AddaccountPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wem_Fbacc> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "AddaccountPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
