...
{
    [RoutePrefix("v1/bank-security/Wkkinput")]
    public class Wet_WkkController : ApiController {
        IWet_WkkRepository repository = new Wet_WkkRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wet_Wkk postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wet_Wkk postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "WkkInputPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wet_Wkk> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "WkkInputPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
