...
{
    [RoutePrefix("v1/bank-security/FacebookADS")]
    public class Wet_FbadsController : ApiController {
        IWet_FbadsRepository repository = new Wet_FbadsRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wet_Fbads postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wet_Fbads postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "FacebookADSPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wet_Fbads> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "FacebookADSPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
