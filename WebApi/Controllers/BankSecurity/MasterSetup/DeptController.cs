...
{
    [RoutePrefix("v1/bank-security/UserDeptSetup")]
    public class DeptController : ApiController {
        IDeptRepository repository = new DeptRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Dept postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Dept postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "UserDeptSetupPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Dept> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "UserDeptSetupPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
