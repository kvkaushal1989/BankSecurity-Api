...
{
    [RoutePrefix("v1/bank-security/Incometype")]
    public class CMC_IncomeController : ApiController {
        ICMC_IncomeRepository repository = new CMC_IncomeRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(CMC_Income postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(CMC_Income postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "IncometypePaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<CMC_Income> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "IncometypePaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
