...
{
    [RoutePrefix("v1/bank-security/PlayerWithdrawal")]
    public class Wet_WithdrawController : ApiController {
        IWet_WithdrawRepository repository = new Wet_WithdrawRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wet_Withdraw postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wet_Withdraw postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "PlayerWithdrawalPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wet_Withdraw> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "PlayerWithdrawalPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
