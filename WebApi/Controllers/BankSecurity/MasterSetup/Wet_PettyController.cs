...
{
    [RoutePrefix("v1/bank-security/pettycash")]
    public class Wet_PettyController : ApiController {
        IWet_PettyRepository repository = new Wet_PettyRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Wet_Petty postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Wet_Petty postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "PettyCashPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Wet_Petty> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "PettyCashPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
