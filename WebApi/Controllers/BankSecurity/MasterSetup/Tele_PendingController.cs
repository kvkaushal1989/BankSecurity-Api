...
{
    [RoutePrefix("v1/bank-security/Telepending")]
    public class Tele_PendingController : ApiController {
        ITele_PendingRepository repository = new Tele_PendingRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(Tele_Pending postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(Tele_Pending postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "TelependingPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<Tele_Pending> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "TelependingPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
