...
{
    [RoutePrefix("v1/bank-security/CSPendingList")]
    public class CS_PendingController : ApiController {
        ICS_PendingRepository repository = new CS_PendingRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(CS_Pending postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(CS_Pending postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "CSPendingListPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<CS_Pending> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "CSPendingListPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
