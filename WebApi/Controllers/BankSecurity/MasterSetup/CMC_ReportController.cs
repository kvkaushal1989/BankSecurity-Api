...
{
    [RoutePrefix("v1/bank-security/ReportSetup")]
    public class CMC_ReportController : ApiController {
        ICMC_ReportRepository repository = new CMC_ReportRepository();
        ...
        [Route("")]
        [HttpPost]
        public IHttpActionResult CreateRow(CMC_Report postData) {
        ...
        [Route("")]
        [HttpPut]
        public IHttpActionResult UpdateRow(CMC_Report postData) {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        [Route("pagination", Name = "ReportSetupPaginationList")]
        [HttpPost]
        public IHttpActionResult PaginationList(Pagination pagination) {
            ...
            try {
                if (!ModelState.IsValid) {
                    ...
                    List<CMC_Report> paginatedRowArray = null;
                    try {
                        ...
                        linkBuilder = new PageLinkBuilder(Url, "ReportSetupPaginationList", null, pagination.PageNumber, pagination.PageSize, totalRecordCount, pagination.Filter, pagination.SearchText);
